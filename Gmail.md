...
- Inteligencia Artificial: Redacción inteligente (sugerencias de texto) y respuestas rápidas (respuestas sugeridas).
- Gestión de envíos: Programación de correos para enviarse más tarde y posibilidad de deshacer el envío.
- Productividad: Función "Posponer" (Snooze) para ocultar correos y volver a mostrarlos más tarde.
- Integración: Acceso directo a Google Chat y Google Meet desde la bandeja de entrada.
- Funciones sin conexión: Leer, responder y buscar mensajes sin conexión a internet.
- Seguridad: Detección de spam, bloqueo de remitentes y alertas de seguridad.
...
<details>
  <summary>ATAJOS DE TECLADO OFICIALES</summary>
