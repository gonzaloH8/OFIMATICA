...
- Cerrar pestaña actual: Ctrl + F4 / ctrl + w
- Cambiar a pestaña derecha: Ctrl + Tab
- Cambiar a pestaña izquierda: Ctrl + Mayús + Tab
- Abrir una pestaña cerrada recientemente: Ctrl + Mayús + T
- Cerrar toda la ventana: Alt + F4 
- Cambiar vista a las pestañas 1 a 8: Ctrl + tecla de número (1-8)
- Cambiar vista a la última pestaña: Ctrl + 9
- Recargar página: F5 o Ctrl + R.
- Historial: Ctrl + H / Cmd + Y.
- Modo Incógnito/Privado: Ctrl + Shift + N / Cmd + Shift + N.
- Inicio: Alt + Inicio
- Abrir archivo: Ctrl + O
- Atrás: Alt + flecha hacia la izquierda
...
- Marcar la página actual: Ctrl + D
...
- Desplazarse un cuadro hacia abajo: Espacio o AvPág
- Desplazarse un cuadro hacia arriba: Mayús + espacio o RePág
...
- Quitar predicciones de la barra de direcciones: Flecha hacia abajo para resaltar + Mayús + Supr
- Mover el cursor a la barra de direcciones: + F5
- Mostrar u ocultar la barra de marcadores: Ctrl + Mayús + B
- Abrir el Administrador de tareas de Chrome: Mayús + Esc
- Poner el foco en el primer elemento de la barra de herramientas de Chrome: Mayús + Alt + T
...
- Mostrar u ocultar la barra de marcadores: Ctrl + Cmd + 1
- Seleccionar marcadores y carpetas en la barra lateral: Cmd + clic en cada marcador/carpeta
- Seleccionar siguiente marcador o carpeta: Flecha hacia arriba o hacia abajo 
- Abrir marcador seleccionado: Barra espaciadora
- Abrir carpeta seleccionada: Barra espaciadora o flecha hacia la derecha
- Cerrar la carpeta seleccionada: Barra espaciadora o flecha hacia la izquierda
- Mostrar u ocultar la barra lateral con la lista de lectura: Mostrar u ocultar la barra lateral con la lista de lectura
...
- Búsqueda rápida: /
- Búsqueda rápida solo en texto de enlace: ‘
- Cerrar la barra de búsqueda rápida (solo cuando tiene el foco): Esc
- Complementos: Ctrl + Mayús + A
- Depurador: Ctrl + Mayús + Z
- Editor de estilo: Mayús+ F7
- Red: Ctrl + Mayús + E
